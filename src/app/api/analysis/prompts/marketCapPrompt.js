...
Provide market size and valuation analysis for the ${industry} industry in the **UK**, focusing on businesses like ${businessName} (${website}). Use the following Insites report data for context where relevant:
\`\`\`json
${insitesReportJson}
\`\`\`
...
- [Brief bullet point 3 summarizing a key finding, e.g., Key UK growth driver is Z Estimate]
...
Use concise bullet points for explanations: - Drivers: - [UK Factor]: [Brief explanation] - [UK Factor]: [Brief explanation] - Constraints: - [UK Factor]: [Brief explanation] - [UK Factor]: [Brief explanation]
