...
Create a data-focused SEO analysis for ${businessName} (${website}) in the ${industry} industry, focusing on the **UK market**. Use the following Insites report data for context where relevant:
\`\`\`json
${insitesReportJson}
\`\`\`
    ...
    - SEO health score (UK): [0-100] (Estimate based on Insites data like overall_score, backlink profile, technical issues)
    - Top 3 strengths (UK): [bullet points based on Insites data like keywords, domain age, analytics presence]
    - Top 3 weaknesses (UK): [bullet points based on Insites data like thin content, mobile issues, backlink toxicity]
    - Priority recommendations (UK): [action + impact %]
    - Competitive position (UK): [rank in industry]
    - Competitor comparison (UK): [vs ${competitorsString}]

    ## Keyword Rankings (UK - Top 10-20)
    Use a Markdown table based on Insites organic_search data: | Keyword (UK Focus) | Ranking (UK) | Search Volume (UK) | Difficulty (UK) | Opportunity (UK) | Est. Traffic (UK) | |--------------------|--------------|--------------------|-----------------|------------------|-------------------| | [keyword from insites] | [# from insites] | [# from insites] | [Estimate 1-100] | [Estimate 1-10] | [Estimate #] |
    ...
    - Intent breakdown (UK): [% informational, % navigational, % transactional, % commercial] (Estimate based on keywords)
    - Keyword overlap with ${competitorsString} (UK): [% Estimate]

    ## Organic Traffic Metrics Summary (UK Focus)
    Use a Markdown table based on Insites organic_search data: | Metric         | Value                 | UK Industry Benchmark | Comparison | |----------------|-----------------------|-----------------------|------------| | Monthly Sessions (UK Est.) | [${avgMonthlyTraffic}] | [# Estimate] | [Above/Below/Avg] | | YoY Growth (UK Est.)     | [% Estimate]          | [% Estimate] | [Above/Below/Avg] | | Bounce Rate (UK Est.)    | [% Estimate]          | [% Estimate] | [Above/Below/Avg] | | Avg Session (UK Est.)    | [minutes:seconds Est.]| [minutes:seconds Est.]| [Above/Below/Avg] | | Pages/Session (UK Est.)  | [# Estimate]          | [# Estimate] | [Above/Below/Avg] |
    ...
    - Geographic distribution (Top 3 UK Regions/Cities): [Region/City: % Estimate]
    ...
    Use a Markdown table based on Insites amount_of_content data: | Metric                  | Score/Value | Notes | |-------------------------|-------------|-------| | Overall Quality (Est.)  | [Estimate 1-100] | [Brief assessment] | | Content Gaps Identified (UK) | [# Estimate] | [Key UK topics] | | E-E-A-T Signals         | [Strong/Moderate/Weak Estimate] | [Evidence Estimate] | | Content Freshness       | [${contentFreshness}] |       | | Internal Linking        | [Good/Fair/Poor Estimate] | [Opportunities Estimate] |
    ...
    Use a Markdown table for Top 5 Opportunities based on Insites organic_search.best_keyword_opportunities: | Keyword (UK) | Volume (UK) | Difficulty Est. | Relevance | Potential | |--------------|-------------|-----------------|-----------|-----------| | [keyword from insites] | [vol from insites] | [1-100] | [High/Med/Low] | [High/Med/Low] |
    ...
    Use a Markdown table based on Insites local_presence_normalised data: | Metric                | Score/Value | Notes | |-----------------------|-------------|-------| | Google Business Profile (UK) | [Estimate 1-100] | [UK optimisation points] | | Citation Consistency (UK)  | [Estimate %] | [Top UK directories: ${directoriesFound}] | | Local Rankings (UK Avg)  | [# Estimate] | [Key UK cities/regions] | | Reviews (UK Avg Rating)  | [${avgReview}] | [# UK Reviews: ${reviewCount}] |
